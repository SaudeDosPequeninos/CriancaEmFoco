    ...
    <div class="CadastroEscola-form">
        <form action="#" method="POST">
            ...
            <div id="passo2">
                ...
                <input type="text" id="logradouro-cadastrar" name="logradouro-cadastrar" required placeholder="Informe a rua"><br>

                <label for="cep">CEP*:</label>
                <input type="number" id="cep-cadastro" name="cep-cadastro" required pattern="\d{8}" title="Digite 8 dígitos" placeholder="Informe o CEP" maxlength="8" minlength="8"><br>

                <label for="bairro">Bairro*:</label>
                <input type="text" id="bairro-cadastro" name="bairro-cadastro" required placeholder="Informe o bairro"><br>

                <label for="numero">Número*:</label>
                <input type="number" id="numero-cadastro" name="numero-cadastro" required min="1" placeholder="Informe o número e complemento"><br>
            ...
            <div id="passo3">
                ...
                <input type="password" name="senha-cadastro" id="senha-cadastro" required minlength="8" maxlength="20" placeholder="Informe uma senha"><br>
