    ...
    <div class="CadastroEscola-form">
		<form action="inserir-escola" method="post">
            <div id="passo1">
                ...
                <input type="text" id="razao_social_cadastro" name="razao_social_cadastro" required placeholder="Informe o nome"><br>
 
                <label for="nome_fantasia">Nome Fantasia:</label>
                <input type="text" id="nome_fantasia_cadastro" name="nome_fantasia_cadastro" placeholder="Opcional"><br>
                ...
                <input type="email" id="email_cadastro" name="email_cadastro" required placeholder="exemplo@exemplo.com"><br>
            ...
            <div id="passo2" style="display:block;">
                ...
                <input type="text" id="estado_cadastro" name="estado_cadastro" required placeholder="Informe o estado"><br>
 
                <label for="cidade">Cidade*:</label>
                <input type="text" id="cidade_cadastro" name="cidade_cadastro" required placeholder="Informe a cidade"><br>
 
                <label for="logradouro">Logradouro*:</label>
                <input type="text" id="logradouro_cadastro" name="logradouro_cadastro" required placeholder="Informe a rua"><br>
