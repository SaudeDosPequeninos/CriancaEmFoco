		...
		<c:if test="${escola != null}">
			...
			<input type="hidden" name="id-endereco" value="<c:out value='${endereco.id}' />" />
                ...
                <div id="passo1" style="display: block;">
                    <div class="titulo">
                        <img src="<%=request.getContextPath()%>/resources/images/titulo.svg" alt="Titulo Cadastro">
                    </div>

                    <div class="razaoSocial">
                        <label for="razao-social-user" class="text-style obrigatorio">Razão Social</label>
                        <div class="user-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/user-ico.svg" alt="user-ico">
                        </div>
                    ...
                    <div class="nomeFantasia">
                        ...
                        <div class="user-ico-fantasia">
                            <img src="<%=request.getContextPath()%>/resources/images/user-ico.svg" alt="user-ico-fantasia">   
                        </div>
                    ...
                    <div class="cnpj">
                        ...
                        <div class="cnpj-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/cnpj-ico.svg" alt="cnpj-ico">                           
                        </div>
                    ...
                    <div class="telefone">
                        ...
                        <div class="tel-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/telefone-ico.svg" alt="telefone-ico">                  
                        </div>
                    ...
                    <div class="email">
                        ...
                        <div class="email-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/email-ico.svg" alt="email-ico">  
                        </div>
                ...
                <div id="passo2" style="display:none;">
                    <div class="titulo-cadastro2">
                        <img src="<%=request.getContextPath()%>/resources/images/titulo2.svg" alt="titulo-cadastro2">                   
                    </div>

                    <div class="estado">
                        <label for="estado-user" class="text-style obrigatorio">Estado</label>
                        <div class="estado-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/estado-ico.svg" alt="estado-ico">                  
                        </div>
                    ...
                    <div class="cidade">
                        ...
                        <div class="cidade-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/estado-ico.svg" alt="cidade-ico">
                        </div>
                    ...
                    <div class="logradouro">
                        ...
                        <div class="logradouro-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/logradouro-ico.svg" alt="logradouro-ico">
                        </div>
                    ...
                    <div class="cep">
                        ...
                        <div class="cep-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/cep-ico.svg" alt="cep-ico">
                        </div>
                    ...
                    <div class="tipo">
                        ...
                        <div class="tipo-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/tipo-ico.svg" alt="tipo-ico">
                        </div>
                    ...
                    <div class="bairro">
                        ...
                        <div class="bairro-ico">
                            <img src="<%=request.getContextPath()%>/resources/images/bairro-ico.svg" alt="bairro-ico">
                        </div>
                    ...
                    <div class="numero">
                    	...
                    	<div class="numero-ico">
                    		<img src="<%=request.getContextPath()%>/resources/images/numero-ico.svg" alt="numero-ico">
                    	</div>
                    ...
                    <button type="button" id="voltar-passo1" onclick="voltar('passo2', 'passo1')">VOLTAR</button>
				...
				<div id="passo3" style="display:none;">
				    ...
				    <div class="senha">
				        ...
				        <div class="icone-senha">
				            <div class="senha-fechada-ico">
				                <img src="<%=request.getContextPath()%>/resources/images/senha-fechada.svg" alt="senha-fechada-ico">
				            </div>
				
				            <div class="olho-senha" id="olho-aberto">
				                <img src="<%=request.getContextPath()%>/resources/images/olho-ico.svg" alt="olho-senha-aberto" onclick="toggleIco()">
				            </div>
				
				            <div class="olho-senha-fechado" id="olho-fechado" style="display: none;">
				                <img src="<%=request.getContextPath()%>/resources/images/olho-fechado.svg" alt="olho-senha-fechado" onclick="toggleIco()">
				            </div>
				        </div>
				    ...
				    <div class="confirmar-senha">
				        ...
				        <div class="icone-confirmar-senha">
				            <div class="confirmar-senha-fechada-ico">
				                <img src="<%=request.getContextPath()%>/resources/images/senha-aberta.svg" alt="senha-fechada-ico">
				            </div>
				
				            <div class="olho-senha-aberto-confirmar-senha" id="olho-aberto-confirmar">
				                <img src="<%=request.getContextPath()%>/resources/images/olho-ico.svg" alt="olho-senha-aberto" onclick="toggleIcoConfirmarSenha()">
				            </div>
				
				            <div class="olho-senha-fechado-confirmar-senha" id="olho-fechado-confirmar" style="display: none;">
				                <img src="<%=request.getContextPath()%>/resources/images/olho-fechado.svg" alt="olho-senha-fechado" onclick="toggleIcoConfirmarSenha()">
				            </div>
				        </div>
				    ...
				    <div class="voltar">
				        ...
				        <div class="voltar-botao">
				            <button type="button" class="voltar-botao-style" onclick="voltar('passo3', 'passo2')">VOLTAR</button>
				        </div>
				    </div>
